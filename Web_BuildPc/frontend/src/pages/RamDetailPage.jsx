              ...
              {rams.map((item) => (
                <tr key={item._id} className="hover:bg-primary-light/50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold">
                    ...
                    <Link to={`/component/ram/${item._id}`} className="text-white hover:text-accent transition-colors">
                      {item.name}
                    </Link>
                  </td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-neutral-300 font-bold text-accent">{item.capacity} GB</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-neutral-300">{item.speed} MHz</td>
